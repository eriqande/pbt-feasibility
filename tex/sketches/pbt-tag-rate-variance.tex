% Notes:
%
% Consider more the issue of fixed vs estimated G. 
 
% A sentence about assessing the survival frates of different experimental release groups.
% and the need for many families in each release group there.
%
% Change "fishery" to recovery areas or recovery strata, WHEN APPROPRIATE. Also designate things
% as Ocean or Freshwater fisheries.  Also, check for the word "catch"  (consider "expanded number")...
%
% change abstract to summary and don't indent it.  Toss the TOC.
%
%
...
\caption{Histograms showing the number of fishery recoveries having different values of $m$.  The different
